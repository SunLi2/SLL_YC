...
import com.zsc.imagesbed.access.HttpOrHttpsAccess;
import com.zsc.imagesbed.log.Logger;
import com.zsc.imagesbed.main.SimpleCurrentLimiter;
import com.zsc.imagesbed.prop.Prop;
import com.zsc.imagesbed.result.Result;
import com.zsc.imagesbed.tool.IPUtil;
...
public class UploadController {
    @Value("${save.upload_image_path}")
    private static String Save_Upload_image_Path;
