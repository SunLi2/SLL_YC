package com.zsc.wxapp.aspect;

import com.zsc.wxapp.annotation.AutoFill;
import com.zsc.wxapp.constant.AutoFillConstant;
...
public class AutoFillAspect {
     ...
     * 切入点
     */
    @Pointcut("execution(* com.zsc.wxapp.mapper.*.*(..)) && @annotation(com.zsc.wxapp.annotation.AutoFill)")
