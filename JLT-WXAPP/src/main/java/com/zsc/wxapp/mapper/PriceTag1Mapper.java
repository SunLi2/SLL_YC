...
@Repository
public interface PriceTag1Mapper {
//
//    @Insert({
//            "<script>",
...
//            "AND product_upload_date >= CURDATE() - INTERVAL 90 DAY")
//    List<PriceNameData> getPriceData(String productUuid);
//
//    @Select("SELECT direct_retail_price, direct_whole_price, is_province, product_type_code, " +
